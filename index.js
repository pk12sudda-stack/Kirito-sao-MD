...
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
  ...
  const sessdata = config.SESSION_ID.replace("kirito~", '')
    ...
    conn.ev.on('connection.update', async (update) => {
      ...
      if (connection === 'close') {
        ...
        try {
          ...
          let up = `*Hᴇʟʟᴏ ᴛʜᴇʀᴇ Kirito-sao-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ! 👋🏻* 
...
https://github.com/NaCkS-ai/Kirito-sao-MD.git

> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ dev sung`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/j4vrw9.jpg` }, caption: up })
